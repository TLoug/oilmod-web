    ...
    <mat-tab-group>
      <mat-tab label="Buttons">
        <mat-card class="sto-card">
          <mat-card-content class="mat-mdc-body-1">
      ...
      <mat-tab label="Cards">
        <div *ngFor="let color of colors">
          <mat-card [ngClass]="'mat-mdc-outlined'" appearance="outlined">
            <mat-card-content>
              <mat-card-title cla>outlined</mat-card-title>
            </mat-card-content>
          </mat-card>
          <mat-card [ngClass]="'mat-mdc-filled'" appearance="raised">
            <mat-card-content>
      ...
      <mat-tab label="Text">
        <mat-card class="sto-card">
          <mat-card-content class="mat-mdc-body-1">
            <div class="container">
              <div>
                <p *ngFor="let color of colors" [ngClass]="'mat-mdc-' + color">
                  &lt;p&gt; {{ color }}
                </p>
              </div>
              <div>
